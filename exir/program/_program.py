    ...
    for name, program in aten_programs.items():
        ...
        if partitioner is not None:
            ...
            for curr_partitioner in partitioners_for_program:
                ...
                # Check if this partitioner can skip EDGE_DO_NOT_DECOMP
                ...
                if can_skip_using_edge_do_not_decomp:
                    ...
                    curr_ops_no_decomp = _remove_invalid_ops_for_not_decompose(curr_ops_no_decomp)
                    ...
                    preserved_ops = _replace_aten_ops_with_transformed_ops(
        ...
        edge_programs[name] = _generate_edge_program(
            config,
            program,
            preserve_ops=ops_set_to_not_decompose_by_program[name],
        )
...
def to_edge_transform_and_lower(  # noqa: C901
    ...
    for name, program in edge_manager._edge_programs.items():
        ...
        for curr_partitioner in partitioners:
            ...
            # Apply per-partitioner logic for ops filtering
